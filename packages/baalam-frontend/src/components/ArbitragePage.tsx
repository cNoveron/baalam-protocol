...
interface ArbitragePageProps {
  ...
  createChartData: (portfolioData: { labels: string[], data: number[] }, color: string) => any // eslint-disable-line @typescript-eslint/no-explicit-any
  chartOptions: any // eslint-disable-line @typescript-eslint/no-explicit-any
}
